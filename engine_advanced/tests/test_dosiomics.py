"""Feature-maths tests on SYNTHETIC TEST FIXTURES (never a production dosiomics source).

Production safety - that generated voxels cannot reach a real analysis - is covered separately in
