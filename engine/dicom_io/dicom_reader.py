...
class DicomPlanReader:
    ...
    def load_patient_dicom(
        ...
        # Malformed RTSTRUCT (no ROIs) fails here rather than yielding empty features later.
        from dicom_io.input_validation import ensure_rtstruct_has_rois

        ensure_rtstruct_has_rois(rt_struct)
