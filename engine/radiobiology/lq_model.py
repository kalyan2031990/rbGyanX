...
def eqd2(total_dose_gy: float, dose_per_fraction_gy: float, alpha_beta_gy: float) -> float:
...
def treatment_time_days(n_fractions: int, fractions_per_week: float = 5.0) -> float:
