...
def fit_xgboost_tcp(
    ...
    """
    XGBoost with nested cross-validation for TCP binary outcome prediction.
    """
    _require_xgb()
    ...
    pg = param_grid or XGBOOST_PARAM_GRID
    warns: list[str] = []
    ...
    xgb_step = final_model.named_steps["xgb"]
    importances = dict(zip(fname, xgb_step.feature_importances_.tolist(), strict=True))
